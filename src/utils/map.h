...
typedef void (*hashmap_callback)(
    void *key, size_t ksize, uintptr_t value, void *usr);
...
// via a callback.
void hashmap_remove_free(
    hashmap *m, void *key, size_t ksize, hashmap_callback c, void *usr);
#endif
